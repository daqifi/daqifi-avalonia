...
/// <summary>
/// Guards what makes <c>DevicesMobileView.axaml</c>'s 65 bindings the XAML compiler's business rather
...
/// </summary>
public class DevicesMobileViewBindingTests
{
    private const string View = "Daqifi.Avalonia/Views/Mobile/DevicesMobileView.axaml";

    /// <summary>
    /// Delete <c>x:CompileBindings</c> and all 65 bindings go back on reflection with every head still
