...
/// <summary>
/// Guards what makes <c>NotificationsFlyout.axaml</c>'s 7 bindings the XAML compiler's business rather
...
/// </summary>
public class NotificationsFlyoutBindingTests
{
    private const string View = "Daqifi.Avalonia/Daqifi.Desktop/View/Flyouts/NotificationsFlyout.axaml";

    /// <summary>
    /// Delete <c>x:CompileBindings</c> and all 7 bindings go back on reflection with every head still
    ...
    public void The_flyout_declares_its_data_type(string attribute, string value) =>
