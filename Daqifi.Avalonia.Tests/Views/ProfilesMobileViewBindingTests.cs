...
/// <summary>
/// Guards what makes <c>ProfilesMobileView.axaml</c>'s 70 bindings the XAML compiler's business rather
...
/// </summary>
public class ProfilesMobileViewBindingTests
{
    private const string View = "Daqifi.Avalonia/Views/Mobile/ProfilesMobileView.axaml";

    /// <summary>
    /// Delete <c>x:CompileBindings</c> and all 70 bindings go back on reflection with every head still
    ...
    /// </summary>
    [Theory]
    [InlineData("DataType", "vm:ProfilesPaneViewModel")]
